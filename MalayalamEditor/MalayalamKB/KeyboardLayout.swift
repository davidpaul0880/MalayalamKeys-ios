...
enum ColorMode : Int {
    case lightMode = 0
    case darkMode = 1
    case darkModeSolid = 2
}

class GlobalColors: NSObject {
    
    static var selectedColorMode: ColorMode = .darkModeSolid
    
    class var regularKey: UIColor {
        ...
        case .darkMode:
            return UIColor.black.withAlphaComponent(CGFloat(0.25))
    ...
    class var specialKey: UIColor {
        
        switch selectedColorMode {
        case .lightMode:
            
            return UIColor(red: CGFloat(191)/CGFloat(255), green: CGFloat(136)/CGFloat(255), blue: CGFloat(65)/CGFloat(255), alpha: 1)
    ...
    //class var darkModeSolidColorRegularKey: UIColor { get {  }}
   //177
   // class var lightModeSolidColorSpecialKey: UIColor { get { return UIColor(red: CGFloat(189)/CGFloat(255), green: CGFloat(222)/CGFloat(255), blue: CGFloat(189)/CGFloat(255), alpha: 1) }}
    ...
    static var shiftKeyDown: UIColor {
        switch selectedColorMode {
        case .lightMode:
            return regularKey
            
        case .darkMode,.darkModeSolid:
    ...
    //class var lightModeUnderColor: UIColor { get {  }}
    //class var darkModeUnderColor: UIColor { get {  }}
    ...
    //class var lightModeTextColor: UIColor { get { return  }}
    //class var darkModeTextColor: UIColor { get {  }}
    ...
    static var popupColor : UIColor {
        switch selectedColorMode {
        case .lightMode:
            return GlobalColors.regularKey
    ...
    static var downTextColor : UIColor? {
        switch selectedColorMode {
        case .lightMode:
            return UIColor.black
    ...
    static var extDownColor: UIColor{
        switch selectedColorMode {
        case .lightMode:
            return UIColor(red: CGFloat(191)/CGFloat(255), green: CGFloat(136)/CGFloat(255), blue: CGFloat(65)/CGFloat(255), alpha: 1)
    ...
    static var popupButtonBGColor: UIColor{
        switch selectedColorMode {
        case .lightMode:
        return UIColor.white
    ...
    static var popupButtonSelectedBGColor: UIColor {
        switch selectedColorMode {
        case .lightMode:
        return UIColor(red: CGFloat(191)/CGFloat(255), green: CGFloat(136)/CGFloat(255), blue: CGFloat(65)/CGFloat(255), alpha: 1)
    ...
    static var popupButtonTextColor: UIColor {
        switch selectedColorMode {
        case .lightMode:
        return UIColor.black
    ...
    static var popupButtonSelectedTextColor: UIColor {
        switch selectedColorMode {
        case .lightMode:
        return UIColor.white
...
class KeyboardLayout: NSObject, KeyboardKeyProtocol {
    ...
    func setAppearanceForKey(_ key: KeyboardKey, model: Key, darkMode: Bool, solidColorMode: Bool) {
        ...
        Key.KeyType.character:
            //if model.uppercaseKeyCap == nil
            key.color = GlobalColors.regularKey
            if model.lowercaseKeyCap == nil {
                key.textColor = GlobalColors.textColor
            } else {
                key.downTextColor = GlobalColors.textColor
                //key.textColor = nil
            }
            if UIDevice.current.userInterfaceIdiom == UIUserInterfaceIdiom.pad || UserDefaults.standard.bool(forKey: kDisablePopupKeys) { //+20150102
                key.downColor = GlobalColors.specialKey
            }
        case
        ...
        Key.KeyType.numberMalayalam:
            key.color = GlobalColors.specialKey
            key.textColor = GlobalColors.textColor
            if UIDevice.current.userInterfaceIdiom == UIUserInterfaceIdiom.pad || UserDefaults.standard.bool(forKey: kDisablePopupKeys) { //+20150102
                key.downColor = GlobalColors.specialKey
            }
        ...
        Key.KeyType.shift:
            key.color = GlobalColors.specialKey
            key.downColor = GlobalColors.shiftKeyDown
            key.textColor = UIColor.white
            key.downTextColor = UIColor.black
        case
        Key.KeyType.backspace:
            key.color = GlobalColors.specialKey
            // TODO: actually a bit different
            key.downColor = GlobalColors.regularKey
            key.textColor = UIColor.white
            key.downTextColor = GlobalColors.downTextColor
        case
        ...
        key.underColor = GlobalColors.underColor
        key.borderColor = GlobalColors.borderColor
        key.popupColor = GlobalColors.popupColor//+20150105
    ...
    //m+20150107
    func layoutSpecialKeysRow(_ r:Int, row: [Key], modelToView: [Key:KeyboardKey], gapWidth: CGFloat, leftSideRatio: CGFloat, rightSideRatio: CGFloat, micButtonRatio: CGFloat, isLandscape: Bool, frame: CGRect) {
        ...
        if !isPad && !isLandscape && row.count == 8 {
            ...
            let newwidth: CGFloat = rightButtonWidth * micButtonRatio
            ...
            if let view = modelToView[key] {
                if key.type == Key.KeyType.space {
                    ...
                    if k == 0 {
                        ...
                        view.frame = CGRect(x: rounded(currentOrigin), y: frame.origin.y, width: leftButtonWidth + width123adjust, height: frame.height)
                    ...
                    view.frame = CGRect(x: rounded(currentOrigin), y: frame.origin.y, width: rightButtonWidth, height: frame.height)
